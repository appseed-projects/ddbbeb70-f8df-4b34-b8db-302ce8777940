...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-19 10:29`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ddbbeb70-f8df-4b34-b8db-302ce8777940.git
$ cd ddbbeb70-f8df-4b34-b8db-302ce8777940
```
